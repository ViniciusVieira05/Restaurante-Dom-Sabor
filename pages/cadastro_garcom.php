...
if(isset($_POST['cadastrar'])){
    ...
    try{
        ...
        $mensagem = "Garçom cadastrado com sucesso!";
...
if(isset($_GET['excluir'])){
    ...
    try{
        ...
        if($pedidosCount > 0){
            throw new Exception("Não é possível excluir este garçom porque ele possui pedidos registrados.");
        }
        ...
        $erro = $e->getMessage() ?: "Não foi possível excluir este garçom.";
    }
}
?>
            ...
            <tbody>
                ...
                <?php foreach($garcons as $garcom): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            GAR-<?php echo str_pad($garcom['id'],3,'0',STR_PAD_LEFT); ?>
                            </td>

                            <td><?php echo $garcom['nome']; ?></td>

                            <td><?php echo $garcom['cpf']; ?></td>

                            <td><?php echo $garcom['telefone']; ?></td>

                            <td><?php echo $garcom['usuario']; ?></td>

                            <td>
                            R$ <?php echo number_format($garcom['salario'],2,',','.'); ?>
                            </td>

                            <td>
                            <?php echo date('d/m/Y', strtotime($garcom['data_admissao'])); ?>
                            </td>

                            <td>

                            <?php if($garcom['status']=='ativo'): ?>
                            ...
                            <a
                            href="editar_garcom.php?id=<?php echo $garcom['id']; ?>"
                            ...
                            <a
                            href="?excluir=<?php echo $garcom['usuario_id']; ?>"
                            class="btn btn-danger btn-sm"
                            onclick="return confirm('Excluir este garçom?')">
